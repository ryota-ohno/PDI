...
from make_column_xyz import exec_gjf##計算した点のxyzfileを出す
        ...
        for i in range(len(dict_matrix)):
            ...
            if isAvailable:
                ...
                if not(alreadyCalculated):
                    ...
                    df_newline = pd.Series({**params_dict,'E':0.,'E1':0.,'E2':0.,'machine_type':1,'status':'qw','file_name':file_name})
                    df_E=df_E.append(df_newline,ignore_index=True)
                    df_E.to_csv(auto_csv,index=False)
